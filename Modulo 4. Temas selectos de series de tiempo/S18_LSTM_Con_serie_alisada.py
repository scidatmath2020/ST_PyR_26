...
INPC = bie_inegi.Series_INEGI_BIE(
  id_serie = 910392,
  token = token_id,
  periodo = "Mensual"
)
...
INPC_t = INPC.set_index("Fecha")
INPC_t = pd.Series(INPC_t.Serie, index = INPC_t.index)
INPC_t


# Escalar el INPC_t

INPC_array = INPC_t.values.reshape(-1,1)
scaler = StandardScaler()
INPC_scaled = scaler.fit_transform(INPC_array)
INPC_scaled
...
pasos = 10
X, y = crear_secuencias(INPC_scaled , pasos)
